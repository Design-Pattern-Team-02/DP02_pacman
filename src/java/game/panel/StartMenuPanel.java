...
//        startButton.addActionListener((ActionEvent e) -> gameManager.changeState(new PlayingState()));
//
...
//        b.setFont(font);
//        b.setForeground(Color.WHITE);           // 흰색 글씨
//        b.setBackground(Color.BLACK);           // 배경은 검은색으로 통일
//        b.setOpaque(true);
